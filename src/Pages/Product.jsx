...
const Product = () => {
  ...
  useEffect(() => {
    const id = formatUrl(null, title, false);
    getPro(id);
  }, []);
  ...
  const renderStars = () => {
    ...
    for (let i = 0; i < 5; i++) {
      const starColor = i < item.rating ? "#FFAD33" : "#D1D5DB";
      stars.push(
        <svg
          key={i}
          width="16"
            ...
            <div className="flex gap-5 flex-col">
              <div className="flex gap-4 flex-col">
                ...
                <div className="flex  text-gray-500 text-sm gap-2 items-center ">
                  {renderStars()}
                  <span>
                    ({item.noOfRatings} {i18n.t("productPage.reviews")})
                ...
                <div className="flex gap-8 ">
                  <p className="text-gray-800 text-xl md:text-2xl ">
                    ...
                    <span className="  ml-2 text-gray-500 text-sm md:text-base line-through ">
                      {item.discount ? item.price : ""}
                    </span>
                  </p>
                  <RatingComp text={i18n.t("productPage.review")} item={item} />{" "}
                </div>
